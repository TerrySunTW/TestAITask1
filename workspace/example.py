...
default_filter1=int(sys.argv[1])
default_filter2=int(sys.argv[2])
default_kernel_size1=int(sys.argv[3]) 
default_kernel_size2=int(sys.argv[4]) 
default_epoch=int(sys.argv[5])
default_batch=int(sys.argv[6]) 
